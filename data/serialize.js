...
class ApartmentComplexSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "name",
            "street", "city", "state", "postal_code", "country",  # keep if you need writable fields
            # OR drop the four columns and expose only full_address if you prefer
            "full_address",
            "unit_count", "occupied_unit_count", "occupancy_rate",
            "buildings",
        ]
