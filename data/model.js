...
zip_validator = RegexValidator(
    regex=r"^\d{5}(?:-\d{4})?$",
    message="Enter a valid 5- or 9-digit U.S. ZIP code.",
)
...
class ApartmentComplex(models.Model):
    ...
    street       = models.CharField(max_length=120)          # “123 Main St”
    city         = models.CharField(max_length=80)
    state        = models.CharField(max_length=30)           # or choices of 2-letter codes
    postal_code  = models.CharField(max_length=10, validators=[zip_validator])
    country      = models.CharField(max_length=56, default="USA")
    def __str__(self):
        return (
            f"{self.name} – {self.street}, "
